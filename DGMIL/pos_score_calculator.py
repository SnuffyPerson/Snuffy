...
def get_clusters(ftrain, nclusters):
    ...
    _, ypred = kmeans.assign(ftrain)  # works without problems
    return ypred
...
# def get_score_and_dis(num_cluster, seed, neg_feats_training, neg_feats_testing, pos_neg_feats_testing,
#                       pos_pos_feats_testing):
