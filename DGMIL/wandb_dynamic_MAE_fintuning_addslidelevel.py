...
if __name__ == "__main__":
    ...
    for epoch in range(1, args.epoch + 1):
        ...
        wandb.log({'train_loss': loss_epoch, 'accuracy of extreme samples validation': val_acc,
                   'accuracy of extreme samples test': orig_acc, 'auc of extreme samples validation': val_auc,
                   'auc of extreme samples test': orig_auc,})
        ...
        dis_neg_train, dis_pos_train = get_score_and_dis_feats(args.num_cluster, args.seed,
                                                               new_train_neg_original_feats,
                                                               new_train_pos_original_feats)

        fintuning_feats, label = main_generator_dynamic(dis_neg_train, neg_feats_training, dis_pos_train,
                                                        pos_feats_training)
        ...
        print(dis_new_testing_feats.shape)
        slide_score_all = []
        slide_label_all = []
